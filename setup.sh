...
collect_user_info() {
  ...
  # Set defaults for fields the full version asks about
  USER_LOCATION=""
...
collect_agent_info() {
  ...
  case "$EMOJI_CHOICE" in
    ...
    11) AGENT_EMOJI="🌟" ;;
    12) AGENT_EMOJI="🐙" ;;
    *) AGENT_EMOJI="$EMOJI_CHOICE" ;;
  esac

  # Set defaults — advanced users customize workspace files directly
  AGENT_VIBE="Helpful, resourceful, and proactive. Gets things done efficiently."
  AGENT_MISSION="Help ${USER_NAME} get things done efficiently and thoughtfully"
  AGENT_EXPERTISE=""
